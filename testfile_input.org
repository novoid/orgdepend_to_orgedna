...
:TRIGGER: FPHD-`(my-capture-insert 'my-year)`-write-slots-to-org(NEXT) FPHD-`(my-capture-insert 'my-year)`-write-slots-to-business-calendar(NEXT) FPHD-`(my-capture-insert 'my-year)`-write-slots-to-paper-calendar(NEXT) FPHD-`(my-capture-insert 'my-year)`-eCampus-created(NEXT)
:END:
...
:PROPERTIES:
:BLOCKER: FPHD-`(my-capture-insert 'my-year)`-get-slot-info
:ID: FPHD-`(my-capture-insert 'my-year)`-write-slots-to-org
:TRIGGER: FPHD-`(my-capture-insert 'my-year)`-define-essay-deadline(NEXT)
:END:
...
:TRIGGER: FPHD-`(my-capture-insert 'my-year)`-setup-eCampus-chapters(NEXT) FPHD-`(my-capture-insert 'my-year)`-read-last-years-emails(NEXT)
:END:
...
:BLOCKER: FPHD-`(my-capture-insert 'my-year)`-eCampus-created
:END:
...
:BLOCKER: FPHD-`(my-capture-insert 'my-year)`-write-slots-to-org
:END:
